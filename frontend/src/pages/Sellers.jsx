        ...
        <body>
          <div class="no-print no-print-bar">
            <div style="display: flex; align-items: center; gap: 6px;">
              ...
              <span style="color: #94a3b8;">• Layout Controls (${totalCount} Sellers)</span>
            </div>
            <div style="display: flex; align-items: center; gap: 6px;">
          ...
          <script>
            ...
            function applyPageSize(size) {
              ...
              const pageChunks = [];
              for (let i = 0; i < sellersData.length; i += size) {
                pageChunks.push(sellersData.slice(i, i + size));
              }
              ...
              container.innerHTML = pageChunks.map((chunk, pageIdx) => {
                ...
                return \`
                  <div class="sheet">
                    <div>
                      <div class="header">
                        ...
                        <div class="stats-inline">
                          <div class="stat-item">Total Vehicles: <strong>\${sellersData.length} Units</strong></div>
                    ...
                    <div class="footer">
                      AL ASR MOTORS Dealership System • Sheet \${pageIdx + 1} of \${totalPages} • Showing records \${chunk.length > 0 ? startIdx + 1 : 0} to \${startIdx + chunk.length} of \${sellersData.length}
                    </div>
                  </div>
                \`;
              }).join('');
